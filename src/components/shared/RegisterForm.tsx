    ...
    <div className="bg-white rounded-2xl shadow-lg p-8">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <div>
          ...
          <select {...register('role')} className="w-full border rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary-500">
      ...
      <p className="mt-4 text-center text-sm text-gray-500">
        Already have one? <Link href="/login" className="text-primary-600 hover:underline">Sign in</Link>
      </p>
    </div>
  )
}
